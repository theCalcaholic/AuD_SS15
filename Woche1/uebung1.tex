...
\begin{math}
    \left(\lim\limits_{n \to \infty}\frac{3n^3 - 6n + 20}{n^3}\right)
    ~=~ \left(\lim\limits_{n \to \infty}\frac{
        3 - \frac{6}{n^2} + \frac{20}{n^3}
    }{
        1
    }\right)
    ~=~ 3 \\\\
    \Rightarrow \text{Es existiert ein endlicher Limes > 0 für die Division der beiden Ausdrücke; d.h. $3n^3 - 6n + 20 \in O(n^3)$.}
\end{math}
